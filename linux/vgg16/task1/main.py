...
def run_judo_discriminator():
    ...
    model.fit_generator(augmentation_train_data, steps_per_epoch=30 , epochs=20, validation_data=augmentation_validation_data, validation_steps=30)#, callbacks=[history, early_stopping])
