def todo(zahyou, savePath, mask_point):
    ...
    for num, i in enumerate(zahyou):
        ...
        fig_vec.savefig(savePath + '/vec/' + str(num+1) + ".jpg")
        fig_first.savefig(savePath + '/toFirst/' + str(num+1) + ".jpg")
        fig_error_x.savefig(savePath + '/error/' + str(num+1) + ".jpg")
        #print(savePath + '/vec/' + str(num+1) + ".jpg")
        plt.close('all')
