...
if __name__=='__main__':
    ...
    print('max_acc-----------------------')
    print(str(max_acc[-1]) + ' : ' + list(map(str, max_acc[:-1])))
    print('min_acc-----------------------')
    print(str(min_acc[-1]) + ' : ' + list(map(str, min_acc[:-1])))
    print('max_fValue--------------------')
    print(str(max_fValue[-1]) + ' : ' + list(map(str, max_fValue[:-1])))
    print('min_fValue--------------------')
    print(str(min_fValue[-1]) + ' : ' + list(map(str, min_fValue[:-1])))