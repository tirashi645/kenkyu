def todo(path, winsizeNum=25):
    ...
    if not os.path.isdir('/media/koshiba/Data/opticalflow/point_data/' + dirName + '/' + videoName + '/winsize/winsize_' + str(winsizeNum)):
        make_dirs.makeDir('/media/koshiba/Data/opticalflow/point_data/' + dirName + '/' + videoName + '/winsize/winsize_' + str(winsizeNum))
    f = open('/media/koshiba/Data/opticalflow/point_data/' + dirName + '/' + videoName + '/winsize/winsize_' + str(winsizeNum) + '/pointData_' + videoName + '.txt', "wb")
