...
def generator_unet_upsampling(img_shape, disc_img_shape, model_name="generator_unet_upsampling"):
    ...
    # Encoder
    first_conv = Conv2D(list_filters_num[0], (3,3), strides=(2,2), name='unet_conv2D_1', padding='same')(unet_input)        # first_conv -> (None, 128, 128, 3)
...
def train():
    ...
    genenrator_model.save(model_dir + '/genenrator.h5')
